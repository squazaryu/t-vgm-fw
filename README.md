...
`t-vgm-dev-001-005` while keeping protocol v1.1. Each accepted issue-level
firmware change advances the final three-digit iteration. Stable releases will
use semantic versions and Git tags such as `v1.0.0`.
